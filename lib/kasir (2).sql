...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2019 at 07:44 AM
...
INSERT INTO `detail_transaksi` (`no_nota`, `id_powder`, `id_penyajian`, `id_topping`, `jumlah`) VALUES
(4, 25, 1, 21, 18000),
(6, 23, 1, 21, 13000),
(7, 25, 2, 21, 18000),
(8, 28, NULL, NULL, 15000),
(9, 28, NULL, NULL, 15000),
(10, 25, 1, 21, 18000);
...
(20, 'Susu Putih', 20, 17.1, 1),
(21, 'Susu Putih', 20, 20, 2),
(22, 'Susu Coklat', 15, 15, 1),
(23, 'Susu Coklat', 15, 15, 2);
...
INSERT INTO `jual` (`no_nota`, `tanggal`, `waktu`, `nama_pembeli`, `total_awal`, `diskon`, `total`, `status`, `id_staff`, `id_region`) VALUES
(2, '2019-10-09', '05:45:34', 'maruf', 13000, 0, 13000, 'Success', 'S0005', 1),
(3, '2019-10-09', '05:48:30', 'marufff', 13000, 0, 13000, 'Success', 'S0005', 1),
(4, '2019-10-09', '05:51:26', 'trecyaa', 18000, 0, 18000, 'Success', 'S0005', 1),
(6, '2019-10-10', '20:06:39', 'sese', 13000, 0, 13000, 'Success', 'S0005', 1),
(7, '2019-10-10', '20:38:28', 'Hello', 18000, 0, 18000, 'Success', 'S0005', 1),
(8, '2019-10-10', '20:42:30', 'pou', 15000, 0, 15000, 'Success', 'S0005', 1),
(9, '2019-10-10', '22:53:07', 'plkkk', 15000, 0, 15000, 'Process', 'S0005', 1),
(10, '2019-10-11', '11:18:07', 'koko', 18000, 0, 18000, 'Process', 'S0005', 1);
...
(23, 1, 'Choco Bar', 10000, 20, 16, 1),
(24, 1, 'Choco Bar', 10000, 20, 20, 2),
(25, 2, 'Choco Hazel', 15000, 20, 17, 1),
(26, 1, 'Choco Twice', 12000, 15, 0, 1),
(28, 5, 'Thai Tea Yakult', 15000, 20, 17, 1);
...
--
ALTER TABLE `detail_ekstra`
  MODIFY `id_detail_ekstra` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ekstra`
  MODIFY `id_ekstra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `powder`
  MODIFY `id_powder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
